  ...
  render() {
    return (
      <div className="whiteSpaceContainer">
          ...
          <article className="TermsInfo">
            <section className="sectionInfo">

              <h2 id="MainTitle">Terms + Conditions</h2>
              <p className="Subtitle">Terms of Service</p>
              <p className="normalText">All buyers (hereinafter 'You' or 'User') need to register by creating a username and a password for login.
                <br />
                <br />
                ...
                <br />
                <br />
                You are responsible for maintaining the confidentiality of the login details and Your account. Artlimes reserves the right to reject Your subscription for any or no reason, in particular, due to User's breach of these Terms of Service.</p>
              <p className="Subtitle">Privacy Policy</p>
              <p className="normalText">User’s personal data handling and protection is governed under the terms hereof and the provisions of General Data Protection Regulation (Regulation EC/679/2016).
                <br />
                <br />
